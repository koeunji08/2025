...
st.markdown(
    """
    <h1 style="text-align:center; font-size:50px; color:#ff4da6;">
        🌸 MBTI 기반 진로 추천 🌸
    </h1>
    <p style="text-align:center; font-size:22px; color:#ff80bf;">
        💖 당신의 MBTI를 선택하면, 찰떡같이 어울리는 직업을 알려드려요 💖
    </p>
    """,
    unsafe_allow_html=True
)
...
if user_mbti in career_dict:
    st.markdown(
        f"<h2 style='text-align:center; color:#ff3399;'>🔮 {user_mbti} 유형 추천 직업 🔮</h2>",
        unsafe_allow_html=True
    )
